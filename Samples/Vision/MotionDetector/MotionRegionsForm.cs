...
namespace MotionDetectorSample
{
	public partial class MotionRegionsForm : Form
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			{
				var imageWidth = defineRegionsControl.BackgroundImage.Width;
				var imageHeight = defineRegionsControl.BackgroundImage.Height;
		...
		{
			var currentMode = defineRegionsControl.DrawingMode;
