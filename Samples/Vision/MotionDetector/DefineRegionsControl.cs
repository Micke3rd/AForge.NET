...
namespace MotionDetectorSample
{
    ...
    public partial class DefineRegionsControl : System.Windows.Forms.Control
    {
        ...
        public Rectangle[] Rectangles
        {
            get
            {
                var rects = new Rectangle[rectangles.Count];
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            // draw rectangles
            using (var pen = new Pen(rectsColor, 1))
            {
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if ((drawingMode==DrawingMode.Rectangular)&&(dragging==true))
            {
                ...
                var rect = new Rectangle(startPoint.X-1, startPoint.Y-1, endPoint.X-startPoint.X+1, endPoint.Y-startPoint.Y+1);
                rectangles.Add(rect);
        ...
        private void DrawSelectionRectangle()
        {
            ...
            var screenStartPoint = this.PointToScreen(start);
            var screenEndPoint = this.PointToScreen(end);
