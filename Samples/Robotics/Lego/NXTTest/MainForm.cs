...
namespace NXTTest
{
    public partial class MainForm : Form
    {
        ...
        {
            var motorState = new NXTBrick.MotorState
            {

                // prepare motor's state to set
                Power=(sbyte)powerUpDown.Value,
                TurnRatio=(sbyte)turnRatioUpDown.Value,
                Mode=((modeOnCheck.Checked) ? NXTBrick.MotorMode.On : NXTBrick.MotorMode.None)|
                ...
                Regulation=regulationModes[regulationModeCombo.SelectedIndex],
                RunState=runStates[runStateCombo.SelectedIndex]
            };
            // tacho limit
            try
            {
