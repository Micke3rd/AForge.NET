    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            try
            {
                ...
                {
                    var cameraName = i+" : "+videoDevices[i-1].Name;
        ...
        {
            var videoSource1 = videoSourcePlayer1.VideoSource;
            var videoSource2 = videoSourcePlayer2.VideoSource;

            var framesReceived1 = 0;
            var framesReceived2 = 0;
            ...
            else
            {
                ...
                var fps1 = 1000.0f*framesReceived1/stopWatch.ElapsedMilliseconds;
                var fps2 = 1000.0f*framesReceived2/stopWatch.ElapsedMilliseconds;
