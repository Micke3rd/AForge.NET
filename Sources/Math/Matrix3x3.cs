...
namespace AForge.Math
{
    ...
    public struct Matrix3x3
    {
        ...
        public void SVD(out Matrix3x3 u, out Vector3 e, out Matrix3x3 v)
        {
            ...
            u=new Matrix3x3
            {
                V00=(float)uArray[0, 0],
                V01=(float)uArray[0, 1],
                V02=(float)uArray[0, 2],
                V10=(float)uArray[1, 0],
                V11=(float)uArray[1, 1],
                V12=(float)uArray[1, 2],
                V20=(float)uArray[2, 0],
                V21=(float)uArray[2, 1],
                V22=(float)uArray[2, 2]
            };

            // build V matrix
            v=new Matrix3x3
            {
                V00=(float)vArray[0, 0],
                V01=(float)vArray[0, 1],
                V02=(float)vArray[0, 2],
                V10=(float)vArray[1, 0],
                V11=(float)vArray[1, 1],
                V12=(float)vArray[1, 2],
                V20=(float)vArray[2, 0],
                V21=(float)vArray[2, 1],
                V22=(float)vArray[2, 2]
            };
