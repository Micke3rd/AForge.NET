...
namespace AForge.MachineLearning
{
    ...
    public class QLearning
    {
        ...
        public double LearningRate
        {
            ...
            set { learningRate=System.Math.Max(0.0, System.Math.Min(1.0, value)); }
        }
        ...
        public double DiscountFactor
        {
            ...
            set { discountFactor=System.Math.Max(0.0, System.Math.Min(1.0, value)); }
        }
        ...
        public void UpdateState(int previousState, int action, double reward, int nextState)
        {
            ...
            var nextActionEstimations = qvalues[nextState];
            // find maximum expected summary reward from the next state
            var maxNextExpectedReward = nextActionEstimations[0];
            ...
            var previousActionEstimations = qvalues[previousState];
