...
namespace AForge.Imaging.Filters
{
	...
	public class CanvasFill : BaseInPlaceFilter
	{
		...
		protected override unsafe void ProcessFilter(UnmanagedImage image)
		{
			...
			var startX = System.Math.Max(0, region.X);
			var startY = System.Math.Max(0, region.Y);
			...
			var stopX = System.Math.Min(width, region.Right);
			var stopY = System.Math.Min(height, region.Bottom);
