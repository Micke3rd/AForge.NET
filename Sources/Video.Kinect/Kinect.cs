...
namespace AForge.Video.Kinect
{
	...
	public class Kinect: IDisposable
	{
		...
		public void GetAccelerometerValues(out double x,out double y,out double z)
		{
			...
			x = tiltState.AccelerometerX / CountsPerGravity * Gravity;
			y = tiltState.AccelerometerY / CountsPerGravity * Gravity;
			z = tiltState.AccelerometerZ / CountsPerGravity * Gravity;
		}
