...
namespace AForge.Video.Kinect
{
	...
	internal static class KinectNative
	{
		...
		public struct TiltState
		{
			...
			public TiltState(short x, short y, short z)
			{
				AccelerometerX = x;
				AccelerometerY = y;
				AccelerometerZ = z;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void FreenectDepthDataCallback(IntPtr device, IntPtr depthData, uint timestamp);

		// Native callback for video image data
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void FreenectVideoDataCallback(IntPtr device, IntPtr imageData, uint timestamp);
