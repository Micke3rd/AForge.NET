...
namespace AForge.Math.Tests
{
	...
	public class Vector3Test
	{
			...
			float expectedX,float expectedY,float expectedZ)
		{
			var vector1 = new Vector3(x1,y1,z1);
			var vector2 = new Vector3(x2,y2,z2);
			var expectedResult = new Vector3(expectedX,expectedY,expectedZ);

			var result1 = vector1 + vector2;
			var result2 = Vector3.Add(vector1,vector2);
			...
			float expectedX,float expectedY,float expectedZ)
		{
			...
			var result1 = vector + value;
			var result2 = Vector3.Add(vector,value);
			...
			float expectedX,float expectedY,float expectedZ)
		{
			...
			var result1 = vector1 - vector2;
			var result2 = Vector3.Subtract(vector1,vector2);
			...
			float expectedX,float expectedY,float expectedZ)
		{
			...
			var result1 = vector - value;
			var result2 = Vector3.Subtract(vector,value);
			...
			float expectedX,float expectedY,float expectedZ)
		{
			...
			var result1 = vector1 * vector2;
			var result2 = Vector3.Multiply(vector1,vector2);
			...
			float expectedX,float expectedY,float expectedZ)
		{
			...
			var result1 = vector * value;
			var result2 = Vector3.Multiply(vector,value);
			...
			float expectedX,float expectedY,float expectedZ)
		{
			...
			var result1 = vector1 / vector2;
			var result2 = Vector3.Divide(vector1,vector2);
			...
			float expectedX,float expectedY,float expectedZ)
		{
			...
			var result1 = vector / value;
			var result2 = Vector3.Divide(vector,value);
