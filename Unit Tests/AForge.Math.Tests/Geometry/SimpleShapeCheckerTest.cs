...
namespace AForge.Math.Geometry.Tests
{
	...
	public class SimpleShapeCheckerTest
	{
		...
		public SimpleShapeCheckerTest()
		{
			...
			{
				var angle = (double)i / 180 * System.Math.PI;
				...
				var distorredRadius = radius + rand.Next(7) - 3;
		...
		private static bool CompareShape(List<IntPoint> shape1,List<IntPoint> shape2)
		{
			...
			var index = shape1.IndexOf(shape2[0]);
			...
			for (var i = 1; i < shape2.Count; i++, index++)
			{
		...
		[DataTestMethod]
		[DataRow(PolygonSubType.Unknown,new int[] { 0,0,100,0,90,10 })]     // just a triangle[DataTestMethod]        [DataRow( PolygonSubType.IsoscelesTriangle, new int[] { 0, 0, 100, 0, 50, 10 } )]        [DataRow( PolygonSubType.IsoscelesTriangle, new int[] { 0, 0, 100, 0, 50, 200 } )]        [DataRow( PolygonSubType.EquilateralTriangle, new int[] { 0, 0, 100, 0, 50, 86 } )]        [DataRow( PolygonSubType.RectangledIsoscelesTriangle, new int[] { 0, 0, 100, 0, 50, 50 } )]        [DataRow( PolygonSubType.RectangledIsoscelesTriangle, new int[] { 0, 0, 100, 0, 0, 100 } )]        [DataRow( PolygonSubType.RectangledTriangle, new int[] { 0, 0, 100, 0, 0, 50 } )]        [DataRow( PolygonSubType.Unknown, new int[] { 0, 0, 100, 0, 90, 50, 10, 70 } )]     // just a quadrilateral[DataTestMethod]        [DataRow( PolygonSubType.Trapezoid, new int[] { 0, 0, 100, 0, 90, 50, 10, 50 } )]        [DataRow( PolygonSubType.Trapezoid, new int[] { 0, 0, 100, 0, 90, 50, 0, 50 } )]        [DataRow( PolygonSubType.Trapezoid, new int[] { 0, 0, 100, 0, 90, 50, 0, 53 } )]    // a bit disformed[DataTestMethod]        [DataRow( PolygonSubType.Parallelogram, new int[] { 0, 0, 100, 0, 120, 50, 20, 50 } )]        [DataRow( PolygonSubType.Parallelogram, new int[] { 0, 0, 100, 0, 70, 50, -30, 50 } )]        [DataRow( PolygonSubType.Rectangle, new int[] { 0, 0, 100, 0, 100, 50, 0, 50 } )]        [DataRow( PolygonSubType.Rectangle, new int[] { 0, 0, 100, 0, 100, 52, -3, 50 } )]   // a bit disformed[DataTestMethod]        [DataRow( PolygonSubType.Square, new int[] { 0, 0, 100, 0, 100, 100, 0, 100 } )]        [DataRow( PolygonSubType.Square, new int[] { 50, 0, 100, 50, 50, 100, 0, 50 } )]        [DataRow( PolygonSubType.Square, new int[] { 51, 0, 100, 49, 50, 101, 1, 50 } )]    // a bit disformed[DataTestMethod]        [DataRow( PolygonSubType.Rhombus, new int[] { 30, 0, 60, 50, 30, 100, 0, 50 } )]        [DataRow( PolygonSubType.Rhombus, new int[] { 0, 0, 100, 0, 130, 95, 30, 95 } )]        [DataRow( PolygonSubType.Unknown, new int[] { 0, 0, 100, 0, 90, 50, 40, 70, 10, 40 } )]     // unknown if 5 corners or more
