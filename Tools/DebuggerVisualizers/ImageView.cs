	...
	public partial class ImageView : Form
	{
		...
		private void ImageView_Load(object sender, EventArgs e)
		{
			if (pictureBox.Image != null)
			{
				...
				var width = System.Math.Max(64, System.Math.Min(800, pictureBox.Image.Width));
				var height = System.Math.Max(64, System.Math.Min(600, pictureBox.Image.Height));
		...
		private void UpdateViewSize()
		{
			...
			var x = (width > imagePanel.ClientSize.Width) ? 0 : (imagePanel.ClientSize.Width - width) / 2;
			var y = (height > imagePanel.ClientSize.Height) ? 0 : (imagePanel.ClientSize.Height - height) / 2;
